...
function scenarioFormModel(options) {
        ...
        self.updateDesignScrollBar = function() {
            ...
            if (designsWizardScrollpane === undefined) {
                ...
                setTimeout(function() {
                    designsWizardScrollpane.reinitialise();
                }, 100);
            }
        };
...
function scenarioModel(options) {
        ...
        self.exportDrawingShapeFileUrl = function() {
            return '/drawing/export/shp/'+ self.uid;
        };
        self.exportPlanningUnitShapeFileUrl = function() {
            return '/scenario/export/shp/'+ self.uid;
        };
...
function scenariosModel(options) {
        ...
        self.toggleGroupMembers = function(obj, e) {
            ...
            if (clickTime - self.lastMembersClickTime > 800) {
                ...
                setTimeout(function() {
                    self.updateSharingScrollBar(groupID);
                }, 300);
            }
        };
        ...
        self.zoomToScenario = function(scenario) {
            if (scenario.layer) {
                ...
                self.addScenarioToMap(scenario, {
                    zoomTo: true
                });
            }
        };
        ...
        self.submitShare = function() {
            ...
            var data = {
                'scenario': self.sharingLayer().uid,
                'groups': self.sharingLayer().selectedGroups()
            };
            $.ajax({

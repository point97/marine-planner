...
class LayerAdmin(admin.ModelAdmin):
    ...
    ordering = ('name',)
    exclude = ('slug_name','themes','summarize_to_grid','filterable','proj','data_overview','compress_display','lookup_field','lookup_table','attribute_event','bookmark','map_tiles','kml')
